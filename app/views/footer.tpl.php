        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach($footerFiveType as $currentType) :?>
                <li>
                  <a href="<?= $router->generate('catalog-type', ['id' => $currentType->getId()]) ?>
                  " class="text-muted"><?=$currentType->getName();?></a>
                </li>
              <?php endforeach; ?>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach($footerFiveBrands as $currentBrand): ?>
              <li>
                <a href="<?= $router->generate('catalog-brand', ['id' => $currentBrand->getId()]) ?>
                " class="text-muted"><?=$currentBrand->getName();?></a>
              </li>
            <?php endforeach; ?>
