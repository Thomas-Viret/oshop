...
<section class="hero">
  ...
  <section class="products-grid">
    <div class="container-fluid">
      ...
      <?php foreach($viewData['types'] as $currentType) :?>
      <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          <div class="product-image">
            <a href="<?= $router->generate('catalog-type', ['id' => $currentType->getId()]) ?>" class="product-hover-overlay-link">
            <?= $currentType->getName()?>
            </a>
          </div>
          <div class="product-action-buttons">
            <a href="#" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
            <a href="<?= $router->generate('catalog-type', ['id' => $currentType->getId()]) ?>" class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
          </div>
