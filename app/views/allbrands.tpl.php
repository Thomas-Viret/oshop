...
<section class="hero">
    <div class="container">
      ...
      <div class="hero-content pb-5 text-center">
        <h1 class="hero-heading">Liste des types</h1>
        <div class="row">
  ...
  <section class="products-grid">
    <div class="container-fluid">
      ...
      <?php foreach($viewData['brands'] as $currentBrand) :?>
      <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          <div class="product-image">
            <a href="<?= $router->generate('catalog-brand', ['id' => $currentBrand->getId()]) ?>" class="product-hover-overlay-link">
            <?= $currentBrand->getName()?>
            </a>
          </div>
          <div class="product-action-buttons">
            <a href="#" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
            <a href="<?= $router->generate('catalog-brand', ['id' => $currentBrand->getId()]) ?>" class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
          </div>
