...
<section class="hero">
    <div class="container">
      ...
      <ol class="breadcrumb justify-content-center">
        ...
        <li class="breadcrumb-item active"><?=$viewData['marque']->getName();?></li>
      </ol>
      <!-- Hero Content-->
      <div class="hero-content pb-5 text-center">
        <h1 class="hero-heading"><?=$viewData['marque']->getName();?></h1>
        <div class="row">
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          <div class="product-image">
            <a href="<?= $router->generate('catalog-product', ['id' => $currentProduct->getId()]) ?>" class="product-hover-overlay-link">
              <img src="<?= $currentProduct->getPicture()?>" alt="product" class="img-fluid">
            </a>
          </div>
